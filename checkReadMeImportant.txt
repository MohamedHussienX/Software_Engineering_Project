...
8. create table if not exists "backendTutorial"."Employee"(
...
11. type command npm install express knex pg in terminal
12. type command npm install nodemon --save-dev
13. go to file db.js
14. change password from 123 to the same password that you used during installing postgres sql 
